...
На вкладке **"Остатки"** отображаются текущие остатки материалов на складах рабочего центра и обороты сырья за смену. На этой вкладке можно сразу узнать какими документами-регистраторами было зафиксировано движение выбранной партии. Для этого необходимо выбрать строку с интересующей партией и нажать на кнопку формирования отчета:

![](WorkPlaceOfShiftWizard.assets/8.png)
![](WorkPlaceOfShiftWizard.assets/9.png)

При выделении нескольких партий, а также одной или нескольких номенклатур, и нажатии на кнопку формирования отчета станет доступен отчет Анализ остатков на складах, отфильтрованный по всем выделенным партиям:

![](WorkPlaceOfShiftWizard.assets/10.png)
![](WorkPlaceOfShiftWizard.assets/11.png)

На панели **"Действия"** доступны следующие операции управления остатками для каждого рабочего центра:
