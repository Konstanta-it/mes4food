...
| Указывать расход ингредиентов | Под каждую строку задания осуществляется [фактическое указание ингредиентов](../../../../Fermentation/AccountinfOfIngredients/ByOperator/ByOperator.md), использованных при производстве | Указывать основной материал | Помимо вспомогательных материалов, указывается основной. Если параметр не включен, то можно выбрать один из стандартных вариантов распределения для основного материала. Основной материал нельзя будет указать при наборке через учетную точку, но он попадет в созданную переработку |
