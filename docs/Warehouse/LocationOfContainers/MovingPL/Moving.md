...
Для активных опций "Вести детальный учет упаковочных листов" и "Упрощенное перемещение" в НКУТ появляется возможность сканирования Упаковочного листа с автоматическим определением его местоположения в ячейке на складе.
...
Если активна функциональная опция "Упрощенное перемещение" в НКУТ, тогда можно пропустить сканирование ячейки и сразу выполнить сканирование упаковочного листа. Тогда местоположение будет определено автоматически, ячейка хранения заполнится в документе.
