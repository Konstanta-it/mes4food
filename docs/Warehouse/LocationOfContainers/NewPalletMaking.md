...
- В открывшейся форме отсканировать штрихкоды коробов (GS1-128). Если включена опция "Указывать количество коробов", тогда после сканирования штрихкода короба появится калькулятор для ввода количества. Номенклатура появится на форме:
