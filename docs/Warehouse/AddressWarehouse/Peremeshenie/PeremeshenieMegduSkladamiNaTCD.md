...
<h2>Упрощенное перемещение продукции на другой склад на ТСД</h2>

В случае, если активна функциональная опция "Упрощенное перемещение" в НКУТ, можно пропустить шаг отбора продукции на складе и выполнить сразу перемещение из любой ячейки хранения склада-отправителя в необходимую ячейку хранения склада-получателя. 

Тогда после выбора РнП с типом "Перемещение" необходимо будет сначала отсканировать ячейку склада-отправителя, далее осуществить сканирование всей продукции к перемещению, а по завершении отсканировать ячейку склада-получателя.

![22](PeremeshenieMegduSkladamiNaTCD.assets/22.png)

![23](PeremeshenieMegduSkladamiNaTCD.assets/23.png)

![24](PeremeshenieMegduSkladamiNaTCD.assets/24.png)