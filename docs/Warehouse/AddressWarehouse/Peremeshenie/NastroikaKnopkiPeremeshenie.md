...
- Упрощенное перемещение - возможность перемещать продукцию из любой ячейки хранения склада-отправителя в необходимую ячейку хранения склада-получателя, минуя ячейки отгрузки и приемки.
