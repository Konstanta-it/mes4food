...
Если включена опция "Указывать количество коробов", тогда после сканирования штрихкода короба появится калькулятор для ввода количества.

![16](PriemkaNaTCD.assets/16.png)
