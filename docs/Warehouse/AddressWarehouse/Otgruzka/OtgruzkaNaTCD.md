...
- Сканировать штрихкоды коробов, которые помещаются на новую паллету. Если включена опция "Указывать количество коробов", тогда после сканирования штрихкода короба появится калькулятор для ввода количества.
