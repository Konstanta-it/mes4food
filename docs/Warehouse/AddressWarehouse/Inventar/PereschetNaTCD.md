...
Инвентаризация на складе с учетом тар более подробно описана в разделе ["Пересчет и Инвентаризация продукции с указанием тары"](../../InventoryContainers/InventoryContainers.md).