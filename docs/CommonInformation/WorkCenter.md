...
- Признак необходимости обеспечения по складам.
...
- Признак Использовать идентификатор линии для оборудования;
- Идентификатор линии для оборудования - поле доступно, если включен соответствующий признак.
